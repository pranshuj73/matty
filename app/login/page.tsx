...
export default function Login() {
  ...
  return (
    <div className="w-full lg:grid lg:grid-cols-2 h-screen">
      <section className="flex flex-col justify-center px-8 py-12 gap-8 mt-16">
        <h1 className="text-4xl font-semibold">Welcome, Anon!</h1>
        <p className="text-balance text-muted-foreground">
          Sign In with Google to continue
        </p>
        <Button variant="outline" className="max-w-[250px]" onClick={() => signIn()}>
      ...
      <div className="hidden bg-muted lg:block">
        <Image
          ...
          width="1920"
          height="1080"
          className="h-full w-full object-cover dark:brightness-[0.5] dark:grayscale border-l-2 border-dashed"
        />
