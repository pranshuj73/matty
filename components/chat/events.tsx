...
export default function Events({ events, displayTZ }: { events: calendar_v3.Schema$Event[], displayTZ?: string }) {
  const formattedEvents = events && events.length !== 0 ? formatEvents(events.slice(0, 5), displayTZ) : [];
