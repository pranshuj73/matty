...
const features = [
  {
    ...
    background: <img className="absolute -right-20 lg:-right-10 top-5 lg:top-24 opacity-60" src="/landing/intuitive-scheduling.svg" />,
...
},
{
    ...
    background: <img className="absolute -top-20 right-0 lg:top-5 opacity-60 max-h-[300px]" src="/landing/goal-tracking.svg" />,
...
},
{
    ...
    background: <img className="absolute -right-20 top-1/2 -translate-y-1/2 opacity-60" src="/landing/seamless-integration.svg" />,
