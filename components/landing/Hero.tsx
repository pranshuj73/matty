  ...
  return (
    <main className="relative flex flex-col items-center justify-center min-h-screen text-center">
      <div className="relative max-w-screen-lg flex flex-col items-center justify-center">
        ...
        <div className="shadow-[0px_0px_300px_0px_#63b3edaa] top-full bg-black absolute mt-24 -z-10 hidden sm:flex max-w-screen-lg w-full h-auto aspect-video flex-col items-center justify-center overflow-hidden rounded-lg border bg-background">
