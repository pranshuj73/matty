  ...
  return (
    <main className="relative flex flex-col items-center justify-center min-h-screen text-center">
      <div className="relative max-w-screen-lg flex flex-col items-center justify-center">
        <Link href="https://discord.gg/4g6gvp6Q9v" className="group scale-75 md:scale-100 -mt-12 mb-2 rounded-full border border-black/5 bg-neutral-100 text-base text-white transition-all ease-in hover:cursor-pointer hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-neutral-800" target="_blank" rel="noreferrer noopener">
        ...
        <div className="top-full -z-10 bg-black absolute mt-24 hidden sm:flex max-w-screen-lg w-full h-auto aspect-video flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
