...
export default function Navbar() {
  return (
    <header className="absolute top-5 left-1/2 -translate-x-1/2 z-50 max-w-[90%] md:max-w-screen-lg w-full backdrop-blur-md bg-neutral-700/5 border-white/10 border-2 rounded-lg">
