      ...
      <nav className="flex items-center justify-between px-4 py-2 mx-auto">
        ...
        <div className="flex items-center text-xs md:text-sm">
          <Button className="group scale-90" variant={"secondary"} size={"sm"} asChild>
            <Link href="https://discord.gg/4g6gvp6Q9v" target="_blank" rel="noreferrer noopener" aria-label="Join Discord">
              <svg className="md:mr-2 size-4 group-hover:animate-wiggle" xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" viewBox="0 0 16 16">
