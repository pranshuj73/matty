...
export default function Pros() {
  ...
  return (
    <section className="max-w-screen-lg grid md:grid-cols-2 items-center">
      <div className="col-span-1">
        <h3 className="text-4xl md:text-5xl font-semibold">Focus on what matters most.</h3>
      ...
      <div className="col-span-1 max hidden md:flex items-end overflow-hidden aspect-square p-6 md:p-20 ml-0 fade-t-edge">
        <Image className="w-full h-auto" src="/landing/pros.svg" width={1000} height={1000} alt="Hassle Free Scheduling" />
      </div>
      <div className="col-span-1">
        <h3 className="text-4xl md:text-5xl font-semibold">Human-like Interactions.</h3>
        ...
        <p className={pClasses}>Need to schedule a meeting with your team? Just say "Find a time that works for everyone to discuss the marketing campaign next week." and let Matty take care of it.</p>
      </div>
    </section>
  )
}