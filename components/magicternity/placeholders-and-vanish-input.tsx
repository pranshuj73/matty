...
export function PlaceholdersAndVanishInput({
  ...
  return (
    ...
    >
      <canvas
        className={cn(
          "absolute pointer-events-none text-base transform scale-50 top-[20%] left-1 sm:left-4 origin-top-left filter invert dark:invert-0 pr-10",
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative z-50 border-none dark:text-white bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-5 pr-10",
        ...
        <AnimatePresence mode="wait">
          {!value && !disabled && (
            <motion.p
              ...
              className="text-foreground/60 pl-2 sm:pl-5 text-left w-[calc(100%-2rem)] truncate"
            >
